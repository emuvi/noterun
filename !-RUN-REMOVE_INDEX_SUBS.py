...
def main() -> int:
    ...
    of files within the script's directory and subfolders to remove index formats.
    
    Returns:
        int: Exit code (0 for success, 1 for errors).
    """
    print("=" * 50)
    print(f"{get_current_time()} 🔹 [STEP] [main] Noterun Remove-Index (Subfolders) Rename Script Initialized")
    print("=" * 50)
