...
def process_renaming_cycle(files_to_process: List[Tuple[str, str]], start_index: int) -> Tuple[int, int]:
    """
...
def main():
    ...
    success_count, failure_count = process_renaming_cycle(files_to_process, current_index)
