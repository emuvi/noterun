...
def main():
    ...
    and string/regex replacing of files within the script's directory and its subfolders.
    """
    print("=" * 70)
    print("   Noterun Date-Based Rename & Replace Script (Recursive) Initialized")
    print("=" * 70)
