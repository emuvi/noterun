...
def process_renaming_cycle(files_to_process: List[str], script_dir: str, start_index: int, user_prefix: str) -> Tuple[int, int]:
    """
    ...
    for i, filename in enumerate(files_to_process, 1):
        ...
        if rename_file(filepath, script_dir, filename, current_index, user_prefix):
            success_count += 1
            current_index += 1
...
def main():
    ...
    func_name = "main"
    print("=" * 50)
    print("   Noterun Prefix-Index Rename Script Initialized")
    print("=" * 50)
    ...
    success_count, failure_count = process_renaming_cycle(files_to_process, script_dir, current_index, user_prefix)
